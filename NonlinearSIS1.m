...
%已知参数
function [timenode, S, I,S1, I1, Percent,Percent1] = NonlinearSIS1(sigma, finaltime, interval)
Lambda=0.25; beta=0.50; mu=0.2; gamma=0.79; alpha=0.4; 
%Lambda=2000; beta=0.90; mu=30; gamma=3; alpha=3; 
%sigma=2;
m=1;
