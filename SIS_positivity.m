...
%已知参数
function [timenode, S, I,S1, I1, Percent,Percent1] = positivity_mian(sigma, finaltime, interval)
Lambda=2000; beta=0.5; mu=25; gamma=20; alpha=0; 
%sigma=2;
m=1;
nonlinearfunction=@(x,y)1./(1+m*x);
%初值
initialS=10; initialI=90;
%时间步长
initialtime=0; 
